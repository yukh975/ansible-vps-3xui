...
```
Шаг 1 — один раз на control node: клонировать репо, настроить конфиг, скопировать x-ui.db
Шаг 2 — для каждого сервера: запустить site-init.yml, затем site-configure.yml
```
